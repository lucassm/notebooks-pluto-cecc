...
A corrente fornecida pela fonte de corrente é a corrente de Norton dada por:
...
Corrente da fonte de corrente em mA: **$(xn[1] * 1.0e3) mA**

Tensão no resistor de carga: **$(Rₗ * xn[2]) V**
"""
