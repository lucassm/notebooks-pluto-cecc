...
md"""
A Primeira Lei de Ohm (uma homenagem ao fı́sico alemão George Simon Ohm, 1787–1854, que estabeleceu sua validade) determina *uma relação matemática linear* entre *a corrente elétrica i que atravessa determinado elemento e a tensão v estabelecida nos seus terminais*.
...
!!! note "Expressão Matemática da Lei de Ohm"
	...
	Em que $V$ é tensão elétrica, $R$ é resistência elétrica e $i$ é correte elétrica. 
"""
...
# ╔═╡ 6c61e5a4-8c76-466a-b9a7-bbfb3be432b0
@bind R Slider(5.0:10.0:1000.0, default=500.0)

# ╔═╡ f3feec8e-e546-4890-b3e1-f6d5ec258ac0
i = 1 / R * v
...
md"""
!!! note "Explicação matemática"
	Como é possível visualizar graficamente, trata-se da equação de uma reta passando pela origem.
	
	$$y(t) = a \cdot t + b$$
	
	Em que, para o problema proposto:
...
Para a segunda situação considera-se a resistência variando para os valores de tensão aplicada nos terminais do resistor.
"""
...
md"""
### Modelo de resistência variável com EDO 
"""
...
Rₖ # variação de resitância para diferentes valores de temperatura
...
# ╔═╡ 657327db-6e1b-4952-8e05-8c954e86d4b1
Vₚ =  10.0

# ╔═╡ 061666c6-b7c0-4403-9e0a-c5ab3981eb4a
md"""
Corrente resultante:
"""

# ╔═╡ ad599d6f-4137-4d61-9a0f-34892d536fe9
Iₚ = Vₚ / Rₚ

# ╔═╡ b3909dac-b3f4-4d38-8a7d-f6e285d84158
md"""
...
manifest_format = "2.0"
project_hash = "8111ea9639002b1d0904bc59478154df3565af7e"
