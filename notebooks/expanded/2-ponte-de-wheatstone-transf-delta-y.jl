...
# ╔═╡ 035319a8-a957-4e1c-9345-e8492d32dec7
md"""
Como montar as equações das malhas?

1. Estabelecemos as três malhas a serem analisadas com correntes estabelecidas no sentido horário.

2. Procede-se à análise de cada uma das malhas.


Malha 1

$3,3k \cdot (i_1 - i_2) - 5 = 0$

$3,3k \cdot i_1 - 3,3k \cdot i_2 + 0,0 \cdot i_3 = 5,0$

Malha 2

$3,3k \cdot (i_2 - i_1) + 3,3k \cdot i_2 + 3,3k \cdot (i_2 - i_3) = 0$

$-3,3k \cdot i_1 + (3,3k + 3,3k + 3,3k) \cdot i_2 - 3,3k \cdot i_3 = 0$

Malha 3

$3,3k \cdot (i_3 - i_2) - 5 = 0$

$0,0 \cdot i_1 - 3,3k \cdot i_2 + 3,3k \cdot i_3 = 5,0$


Agora é só resolver o sistema de equações não lineares e calcular as correntes necessárias:
...
# ╔═╡ 3800f6c8-1884-4a5b-a434-9902eb082fd0
md"""
Como montar as equações para o circuito em Y:

Malha 1

$1,1k \cdot i_1 + 1,1k \cdot (i_1 - i_2) -5 = 0$

$2,2k \cdot i_1 - 1,1k \cdot i_2 = 5,0$

Malha 2

$1,1k \cdot (i_2 - i_1) + 1,1k \cdot i_2 - 5 = 0$

$-1,1k \cdot i_1 + 2,2k \cdot i_2 = 5,0$
